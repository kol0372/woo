...
<article>
	...
	<section>
		...
		<%
			...
			BbsVO vo = BbsDao.getDao().detail(num);
		%>
		<p>
		<form method="post" action="bbsupformadd.jsp">
			<input type="hidden" name="num" value="<%=num%>"> <input
				type="hidden" name="hit" value="<%=vo.getHit()%>"> <input
				type="hidden" name="redate" value="<%=vo.getRedate()%>"> <input
				type="hidden" name="reip" value="<%=vo.getReip()%>">
			<table style="margin: auto; width: 300px">
				<tr>
					<td>subject</td>
					<td><input type="text" name="sub" value="<%=vo.getSub()%>">
					<!-- Ajax & Jquery로 구현하기 --></td>
				</tr>
				<tr>
					<td>Writer</td>
				...
				<tr>
					<td>Content</td>
					<td><textarea rows="10" cols="30" name="cont">
						<%=vo.getCont()%>
						</textarea></td>
				</tr>
				<tr>
					<td colspan="2" style="text-align: right;"><input
						...
						onclick="location='bbslist.jsp'"></td>
				</tr>
			</table>
		</form>
		</p>
