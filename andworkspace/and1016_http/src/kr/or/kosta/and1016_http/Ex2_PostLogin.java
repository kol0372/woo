...
public class Ex2_PostLogin extends Activity {
	private EditText idv, pwdv, adressv;
	private Button btn1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adressv = (EditText)findViewById(R.id.ex2_adtext);
		...
		btn1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				params.add(new BasicNameValuePair("adress", adressv.getText().toString().trim()));
			//	text.setText(getHttpPost(url,params));
			}
		});
	}

	protected void getHttpPost(String url,
