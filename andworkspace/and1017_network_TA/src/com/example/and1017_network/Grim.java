...
public class Grim extends View{
	...
	private New_Semimock semi;
	
	

	public Grim(Context context,Socket s) {
		super(context);
		semi = new New_Semimock();
	...
	protected void onDraw(Canvas canvas) {
		...
		// 선 굵기, 스타일 지정
		paint.setColor(semi.getColor_s());
