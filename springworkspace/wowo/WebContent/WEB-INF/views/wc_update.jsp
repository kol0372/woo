	...
	<tiles:putAttribute name="body">
		<div id="wrap" class="wc_update">
			...
			<div class="container">
				...
				<p align="center">
					<a href="gogekjungbo.kosta"><input class="btn btn-default" type="submit" value="수정"></a>&nbsp;
					<a href="gogekjungbo.kosta"><input class="btn btn-default" type="button" value="취소"></a>
				</p>
			</div>
			<!-- /.container -->
